  ...
  return (
    <AnimatePresence mode="wait">
      <motion.div
        ...
        className={cn(
          "flex max-w-fit fixed top-8 inset-x-0 mx-auto border dark:border-white/[0.2] rounded-full dark:bg-white/10 backdrop-blur-md saturate-150 bg-slate-100 shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)] z-[5000] px-9 py-5  items-center justify-center space-x-8",
          className
        )}
      >
